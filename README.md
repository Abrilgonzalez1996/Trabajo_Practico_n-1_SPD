...
Programé la placa Arduino utilizando el software de programación Arduino IDE. Utilicé un ciclo loop para controlar el cambio de los LEDs, de manera que el semáforo cambiara de verde a amarillo, luego a rojo y de nuevo a verde. Además, también programé una señal auditiva para indicar el cambio de luces y un juego de luces para anticipar el cambio de colores
